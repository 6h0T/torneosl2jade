...
import { ArrowLeft, Calendar, Phone, AlertCircle, Bug } from "lucide-react"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/debug/teams" className="flex items-center text-amber-400 hover:underline">
      ...
      {/* Añadir el componente de diagnóstico SQL */}
      <div className="mt-8">
        <h2 className="text-xl font-bold text-forest-400 mb-4">Diagnóstico de Base de Datos</h2>
        <SupabaseDebug />
      </div>
    </div>
  )
