  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-forest-400 mb-2">{t("teamRanking")}</h1>
          <p className="text-gray-300">{t("rankingDescription")}</p>
        </div>

        <Card className="bg-black/80 backdrop-blur-sm border-jade-800/30">
          <CardHeader>
            <CardTitle className="text-forest-400">{t("rankingTable")}</CardTitle>
          </CardHeader>
          <CardContent>
            {isLoading ? (
            ...
            <CardContent>
              <ul className="space-y-2">
                <li className="flex justify-between">
                  ...
                  <span className="font-bold text-forest-400">100 {t("points")}</span>
                </li>
                <li className="flex justify-between">
                  <span>{t("secondPlace")}</span>
                  <span className="font-bold text-forest-400">75 {t("points")}</span>
                </li>
                <li className="flex justify-between">
                  <span>{t("semifinalist")}</span>
                  <span className="font-bold text-forest-400">50 {t("points")}</span>
                </li>
                <li className="flex justify-between">
                  <span>{t("quarterfinalist")}</span>
                  <span className="font-bold text-forest-400">25 {t("points")}</span>
                </li>
                <li className="flex justify-between">
